...
public class FigurinhasCopa {
	 ...
	 *  Entrada
	 *  A primeira linha contém um inteiro N (1 ≤ N ≤ 100) indicando o número total de figurinhas e espaços no álbum. A segunda linha contém um inteiro M (1 ≤ M ≤ 300) indicando o número de figurinhas já compradas.
	...
	public static void main(String[] args) {
		...
		int totalFigurinhas = entrada.nextInt();
		int nFigurinhas = entrada.nextInt();
		...
		System.out.println(totalFigurinhas - total);
		entrada.close();
